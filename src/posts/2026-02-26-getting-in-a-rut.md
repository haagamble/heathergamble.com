...
This past week I slipped into a familiar kind of language‑learning rut — the kind that looks productive from the outside but doesn’t actually help very much. I’ve been using Duolingo for Greek, and if you’ve used the app, you know how skillfully they gamify everything: leagues, levels, bright little fireworks when you win. <!-- excerpt --> I love a good game, so it’s easy for me to get hooked, and that’s exactly what happened. Over the past few weeks I worked my way into the tournament, then into the finals, and once I made it that far I couldn’t resist trying for first place. Before I knew it, I was frantically racing for points and trying to stay ahead of a fierce competitor.
