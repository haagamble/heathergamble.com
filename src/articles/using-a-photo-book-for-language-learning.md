...
Decide what kind of language you need to work on, and ask your language helper to look through all of the pictures and make sentences. Make a recording of this.
...
- use at least one sentence to describe each person e.g. â€œThis man has a beard. This is a short lady. The baby is cute.â€ etc.
...
1. **Listening to a description about a single picture**
...
2. **Speaking practice with the whole photo book**
...
3. **Speaking about a single picture**
